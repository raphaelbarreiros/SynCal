...
CREATE TABLE connectors (
  ...
  type TEXT NOT NULL CHECK (type IN ('google','microsoft','html_ics','imap','self_managed')),
  display_name TEXT,
  status TEXT NOT NULL DEFAULT 'pending_validation' CHECK (status IN ('pending_validation','validated','disabled')),
...
CREATE TABLE calendars (
  ...
  display_name TEXT,
  privacy_mode TEXT NOT NULL CHECK (privacy_mode IN ('original_title','busy_placeholder')),
...
CREATE TYPE sync_job_status AS ENUM ('pending','in_progress','retrying','failed','completed');
